...
ALTER TABLE ONLY public.Patient_doctor
  ADD CONSTRAINT Patient_doctor_fkey_0 FOREIGN KEY (doctorId) REFERENCES public.Doctors(id);

ALTER TABLE ONLY public.Patient_doctor
  ADD CONSTRAINT Patient_doctor_fkey_1 FOREIGN KEY (patientId) REFERENCES public.Patients(id);
